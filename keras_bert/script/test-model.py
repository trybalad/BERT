...
data_generator = DataGenerator("./data/corpus_clean.txt", 32, tokenizer, batch_size=64, create_nsr_output=True)
...
# Start training.
train = train_model(sequence_encoder, 32, tokenizer, data_generator, epochs=100,
                    checkpoint_file_path="./data/checkpoint_test13.ckpt", load_checkpoint=True, old_checkpoint="./data/checkpoint_test12.ckpt")
